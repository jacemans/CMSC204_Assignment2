...
public class NotationQueueTest {
	...
	public void testDequeueStudent() {
		...
		try {
			assertTrue("This should have caused an QueueUnderflowException", doubleQ.dequeue() == 1.0);
			assertTrue("This should have caused an QueueUnderflowException", doubleQ.dequeue() == 2.0);
			assertTrue("This should have caused an QueueUnderflowException", doubleQ.dequeue() == 3.0);
		} catch (QueueUnderflowException e) {
			assertTrue("This should have caused an QueueUnderflowException", true);
		}catch (Exception e){
			assertTrue("This should have caused an QueueUnderflowException", false);
	...
	public void testEnqueueStudent() {
		...
		try {
			...
			assertTrue("This should have caused an QueueOverflowException", doubleQ.enqueue(5.0));
			assertTrue("This should have caused an QueueOverflowException", doubleQ.enqueue(6.0));
		} catch (QueueOverflowException e) {
			assertTrue("This should have caused an QueueOverflowException", true);
		}
		catch (Exception e){
